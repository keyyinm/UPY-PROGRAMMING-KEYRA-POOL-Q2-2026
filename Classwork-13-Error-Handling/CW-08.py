...
class IntegrationMethodError(Exception):
    pass
...
try:
    ...
    try:
        ...
        print("The interval endpoints must be numeric values.")

    else:
        try:
            if method not in ["LRM", "RRM", "MRM", "TRAP"]:
                raise IntegrationMethodError(
                    "Invalid integration method. Use LRM, RRM, MRM or TRAP."
                )

        except IntegrationMethodError as e:
            print(e)
